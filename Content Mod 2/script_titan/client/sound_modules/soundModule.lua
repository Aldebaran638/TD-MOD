...
function client.soundModuleInit()
    ...
    _snd_perdition_fire_near[1] = LoadSound("MOD/sound/perdition_beam_fire_mix.ogg")
    _snd_perdition_fire_dist[1] = LoadSound("MOD/sound/distance_perdition_beam_fire_mix.ogg")
    ...
    _snd_perdition_windup_loops[1] = LoadSound("MOD/sound/perdition_beam_windup_mix.ogg")
    ...
    _snd_kinetic_fire_dist = LoadSound("MOD/sound/weapons/kineticArtillery/distance_kinectic_artillery_fire_01.ogg")
    ...
    _snd_kinetic_hit_dist[1] = LoadSound("MOD/sound/weapons/kineticArtillery/distance_kinectic_artillery_hit_01.ogg")
    _snd_kinetic_hit_dist[2] = LoadSound("MOD/sound/weapons/kineticArtillery/distance_kinectic_artillery_hit_01.ogg")
    ...
    _snd_missile_hit_near[1] = LoadSound("MOD/sound/weapons/swarmerMissile/swarmer_missile_hit_01.ogg")
    _snd_missile_hit_near[2] = LoadSound("MOD/sound/weapons/swarmerMissile/swarmer_missile_hit_01.ogg")
    _snd_missile_hit_near[3] = LoadSound("MOD/sound/weapons/swarmerMissile/swarmer_missile_hit_01.ogg")
    _snd_missile_hit_dist[1] = LoadSound("MOD/sound/weapons/swarmerMissile/distance_swarmer_missile_hit_01.ogg")
    _snd_missile_hit_dist[2] = LoadSound("MOD/sound/weapons/swarmerMissile/distance_swarmer_missile_hit_01.ogg")
end
