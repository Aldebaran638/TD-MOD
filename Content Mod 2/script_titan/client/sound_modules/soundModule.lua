...
function client.soundModuleInit()
    ...
    _snd_perdition_windup_loops[1] = LoadSound("MOD/sound/perdition_beam_windup_01.ogg")
    _snd_perdition_windup_loops[2] = LoadSound("MOD/sound/perdition_beam_windup_02.ogg")
