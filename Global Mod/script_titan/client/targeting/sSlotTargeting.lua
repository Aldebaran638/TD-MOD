...
function client.sSlotTargetingTick(dt)
    ...
    local currentMode = (client.getShipMainWeaponMode ~= nil and shipBody ~= 0) and client.getShipMainWeaponMode(shipBody) or "tSlot"
    if shipBody == 0 or currentMode ~= "mSlot" then
