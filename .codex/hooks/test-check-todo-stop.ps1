...
try {
    ...
    Assert-True ([string]$output -match 'block' -and [string]$output -match 'Step 0\.4' -and [string]$output -notmatch 'Continue with Step 0\.1|Continue with Step 0\.3') 'current source skips the exceptional Step 0.1 and Step 0.3 and requests the next unresolved task'
